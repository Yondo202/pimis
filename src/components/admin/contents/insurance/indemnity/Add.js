                    ...
                    <div className="content">
                        ...
                        <InputsParent>
                            <InputStyle >
                                ...
                                <input type="number" name='transaction_number' className="gettInpps" required />
                            </InputStyle> 

                            <InputStyle >
                                <div className="label">Indemnity date <span className="reds">*</span></div>
                                <input type="date" name='date' className="gettInpps" required />
                            </InputStyle>
                        </InputsParent>
