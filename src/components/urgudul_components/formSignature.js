...
function FormSignature(props) {
    ...
    return (
        <div className={`tw-flex tw-items-center ${props.classAppend}`}>
            <SignaturePad canvasProps={{ className: `tw-border tw-border-gray-300 tw-rounded-lg tw-shadow-md ${props.classCanvas}`, ...props.canvasProps }} ref={sigCanvasRef} onEnd={handleDrawSignature} />
