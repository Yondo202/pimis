            ...
            leave={{ bottom: window.innerWidth < 640 ? '-32px' : '-48px' }}>
            {
                show => show && (props =>
                    <div style={props} className="tw-fixed tw-w-full tw-flex tw-justify-center">
                        <div className={`tw-inline-flex tw-items-center tw-flex-grow tw-mx-2 tw-text-sm sm:tw-text-base sm:tw-max-w-lg sm:tw-mx-0 tw-shadow-md tw-rounded-lg tw-p-2 tw-z-50 ${classTheme.bgColor[alert.variant]}`}>
